 ...
 */
public class Sort_BucketSort_ForJunitTest {
    ...
    public int[] bucketSort(int[] num, int bucketSize){
        ...
        // sort every subList
        return sortSubBucket(num, addElementsToList(num,max,min,bucketSize));

    }


    public void maxAndMin(int[] num, int max, int min){
    ...
    public List<List<Integer>> addElementsToList(int[] num, int max, int min, int bucketSize){
    ...
    public int[] sortSubBucket(int[] num, List<List<Integer>> intermediate){
